...
def render_home(
    ...
    install_cta = (
        ...
        '<p class="lede">Add the marketplace, then install whichever bundle '
        'matches the engagement — three domains, zero auth gymnastics.</p>'
        '<pre><code>'
        'copilot plugin marketplace add aiappsgbb/awesome-gbb\n'
        'copilot plugin install awesome-gbb-basic@awesome-gbb       # universal skills\n'
        'copilot plugin install awesome-gbb-azure@awesome-gbb       # + Azure / Foundry / governance\n'
        'copilot plugin install awesome-gbb-threadlight@awesome-gbb # + end-to-end pilot pipeline'
        '</code></pre>'
