...
class FoundryIqGaContractTests(unittest.TestCase):
    ...
    def test_patch_version_records_post_merge_corrections(self) -> None:
        ...
        self.assertEqual(json.loads(PLUGIN.read_text())["version"], "4.29.6")
        marketplace = json.loads(MARKETPLACE.read_text())
        self.assertEqual(marketplace["metadata"]["version"], "4.29.6")
        self.assertEqual(marketplace["plugins"][0]["version"], "4.29.6")
