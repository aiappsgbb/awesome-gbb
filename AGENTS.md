...
**Current coverage (28 skills, 24 with upstream pins):**

| Category | Count | Coverage |
|----------|-------|----------|
| Auto-tier (`runnable: true`) | 24 pins | T0 + T1 + T2 in CI |
...
| Copilot-CLI fixtures | 18 skills | T3 in CI (`copilot-cli-matrix`, see `.github/skill-deps.yml`) |
